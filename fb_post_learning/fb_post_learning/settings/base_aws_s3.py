...
STATICFILES_STORAGE = 'fb_post_learning.common.aws.custom_storages.StaticStorage'
DEFAULT_FILE_STORAGE = 'fb_post_learning.common.aws.custom_storages.MediaStorage'
